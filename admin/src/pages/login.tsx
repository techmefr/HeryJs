    ...
    <div className="flex min-h-screen items-center justify-center bg-neutral-950 text-neutral-100">
      ...
      >
        ...
        <input
          ...
          className="mb-4 w-full rounded border border-neutral-700 bg-neutral-800 px-3 py-2 text-sm outline-none focus:border-orange-500"
        />
        ...
        <button
          ...
          className="mt-2 w-full rounded border border-neutral-700 py-2 text-sm text-neutral-500"
        >
          Continue with OAuth
        </button>
