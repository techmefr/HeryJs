...
import { registerMakeConcernCommands } from './commands/make-concern';
import { registerMakeExportCommand } from './commands/make-export';
import { registerMakeMailCommand } from './commands/make-mail';
...
registerMakeConcernCommands(program);
registerMakeExportCommand(program);
registerMakeMailCommand(program);
