...
import { registerModuleNewCommand } from './commands/module-new';
import { registerModuleValidateCommand } from './commands/module-validate';
...
registerModuleNewCommand(program);
registerModuleValidateCommand(program);
